...
if __name__=="__main__":
    ...
    #ap.add_argument("-i", "--image", required = True, help = "Denoise\\seg2.png") 
    #ap.add_argument("-n", "--segments", required = False, type = int,
     #   help = "# of clusters")
    #args = vars(ap.parse_args())

    image=cv2.imread("Denoise\\seg2.png")
    if 1:
